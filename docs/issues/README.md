...
| [005](closed/005-in-app-notification-system.md) | todo | closed | In-app notification system (restructured → see #010) |
...
| [008](open/008-rename-adminuid-and-payeremail.md) | todo | open | Rename adminUid → creatorUid and payerEmail → paidByEmail (code + data migration) |
